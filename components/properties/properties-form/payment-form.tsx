"use client";
type PropertyCountRange = "1-3" | "4-5" | "6-10" | "11-20" | "21-40" | ">40";
...
export default function PaymentPricingPlans() {
  ...
  const handlePropertyCountChange = (value: string) => {
    setPropertyCount(value as PropertyCountRange);
  };
    ...
    <div className="container px-4 py-16 mx-auto">
      ...
      <div className="mb-8 flex justify-center">
        <div className="inline-flex items-center rounded-lg border p-2 bg-muted">
          ...
          <Select defaultValue="1-3" onValueChange={handlePropertyCountChange}>
          ...
          <Card key={tier.name} className="flex flex-col">
            ...
            <CardFooter>
              <Button
                ...
                style={{
                  backgroundColor:
                    tier.name === "Platinum" ? "#3b82f6" : "transparent",
                  color: tier.name === "Platinum" ? "white" : "#3b82f6",
                  borderColor: "#3b82f6",
                }}
              >
                Get Started
