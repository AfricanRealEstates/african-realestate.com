...
import { Blockquote } from "@/components/blog/block-quote";
import { Border } from "@/components/blog/border";
import { GrayscaleTransitionImage } from "@/components/blog/grayscale-transition-image";
import { StatList, StatListItem } from "@/components/blog/stat-list";
import { TagList, TagListItem } from "@/components/blog/tag-list";
...
export const MDXComponents = {
  ...
  wrapper({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
    return (
      <div
        className={clsx(
          "[&>*]:mx-auto [&>*]:max-w-7xl [&>:first-child]:!mt-0 [&>:last-child]:!mb-0",
          className
        )}
        {...props}
      />
