...
export default async function SocialMediaConnect() {
          ...
          <li className="py-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <span className="block text-base font-semibold text-gray-700 truncate">
                  Facebook account
                </span>
                <Link
                  href="#"
                  className="block text-sm font-normal truncate text-blue-600 hover:underline"
                >
                  {user.facebookLink}
                </Link>
              </div>
