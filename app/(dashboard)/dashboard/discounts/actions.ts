...
export async function revokeDiscount(discountId: string) {
  try {
    ...
    revalidatePath("/dashboard/discounts");
    return { success: true, message: "Discount revoked successfully" };
  } catch (error) {
    console.error("Error revoking discount:", error);
    return { success: false, message: "Failed to revoke discount" };
  }
}
...
export async function deleteRevokedDiscount(discountId: string) {
  try {
    ...
    revalidatePath("/dashboard/discounts");
    return { success: true, message: "Revoked discount deleted successfully" };
  } catch (error) {
    console.error("Error deleting revoked discount:", error);
    return { success: false, message: "Failed to delete revoked discount" };
  }
}
