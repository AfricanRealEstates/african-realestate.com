...
export default function SurroundingFeatures({ property }: { property: any }) {
    ...
    <section className="leading-relaxed">
      <div className="w-full flex flex-col sm:rounded-2xl border-b sm:border sm:border-neutral-200 sm:space-y-2 pb-1 px-4 sm:p-4 xl:p-4">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-2 gap-[25px] mt-1 mb-4 text-sm text-neutral-700">
        ...
        <div className="">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button variant="outline" className="mb-4 mt-4 rounded-full">
                View all
              </Button>
            </DialogTrigger>
