...
export default function OverviewInfo({ description }: { description: string }) {
  ...
  return (
    <div className="mt-4 lg:mt-0 w-full flex flex-col sm:rounded-2xl border-b sm:border-t sm:border-l sm:border-r border-neutral-200  space-y-4 sm:space-y-6 pb-10 px-0 sm:p-4 xl:p-8">
