...
const faqList: FAQItemProps[] = [
  {
    ...
    answer: (
      <div className="space-y-2 leading-relaxed">
        Before selling your home it is important to prepare it well in order to
        attract potential buyers. Start by decluttering and deep-cleaning the
        home. All of these steps will help you present your home in its best
        light for potential buyers.
      </div>
    ),
  },
  {
    ...
    answer: (
      <p>
        The amount of time it takes to sell a home will depend on a variety of
        factors. First, the age of the home is key. Homes that are newer or
        recently renovated tend to sell faster than older homes, while some
        buyers are willing to put in the work to upgrade an older home. Second,
        local market conditions will affect the time it takes to sell a home. A
        robust market favors sellers, as homes typically sell quickly.
      </p>
    ),
  },
  {
    ...
    answer: (
      <div className="space-y-2 leading-relaxed">
        You can do it but its typically not recommended to buy a new home before
        selling your old one. Doing so can put you in a precarious financial
        position where you are responsible for two mortgages. It is rare for two
        home sales to line up perfectly, and most buyers need to close on their
        old home before they can move on to the new one. Buying a new home
        before you sell your old one also means risking long closing periods and
        cash-flow issues. If your new home takes longer to close than expected
        and requires short-term financing, you may be left in a situation where
        you need to meet two mortgage payments using funds that you haven’t yet
        collected from the sale of your old home. It is very necessary to make
        sure you do not deplete your savings or commit a large portion of your
        income, which may make it very difficult for you to meet other financial
        obligations.
      </div>
    ),
  },
