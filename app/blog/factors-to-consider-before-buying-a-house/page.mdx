...
export const article = {
  ...
  coverImage: cover,
  tags: ['mortgage','investing'],
  description:
    'Factors to consider when purchasing a new home or upgrading your house considering House taxes, insurance, home utilities and amenities should also be included in your budget.',
  author: {
    name: 'Jim K',
