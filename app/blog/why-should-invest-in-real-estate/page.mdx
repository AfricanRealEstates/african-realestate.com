...
export const article = {
  ...
  description:
    'Over the years real estate has been doing tremendously well as compared to other businesses. Currently it is one of the best long-term investments that has high returns.',
  author: {
    name: 'Jim K',
